...
function play() {
    ...
    noti.innerText = ""
    how.innerText = "How to play: choose the block\nwhich was lightened!";
    ...
    block[quest].onclick = function () {
        ...
        for (sai = 0; sai < block.length; sai++) {
            block[sai].onclick = function () {
                ...
                noti.innerText = "Press \"Play again\"\nto enjoy more!"
                how.innerText = ""
            }
        }
    }
...
function playNorm() {
    ...
    notiNorm.innerText = ""
    howNorm.innerText = "How to play: choose the blocks\nin the same order\nas lightened!"
            ...
            blockNorm[q2].onclick = function () {
                ...
                for (i = 0; i < blockNorm.length; i++) {
                    blockNorm[i].onclick = function () {
                        ...
                        notiNorm.innerText = "Press \"Play again\"\nto enjoy more!"
                    }
                }
            }
        }
                ...
                blockHard[q3].onclick = function () {
                    ...
                    for (i = 0; i < blockHard.length; i++) {
                        blockHard[i].onclick = function () {
                            ...
                            notiHard.innerText = "Press \"Play again\"\nto enjoy more!"
                        }
                    }
                }
            }
